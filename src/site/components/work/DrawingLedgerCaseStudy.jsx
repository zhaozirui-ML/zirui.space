...
import WorkCaseStudyToc from "./WorkCaseStudyToc";
        ...
        <section className={joinClassNames(styles.fullBleedSection, styles.sectionSurface)}>
          <div className={styles.sectionContent}>
            ...
            <TitleHeader sectionId="case-problem" title="问题定位">
              <p>旧版台账更像一个死的数据容器，主要存在以下 3 类问题：</p>
              <ul>
                <li>所有用户看到相同数据，也会看到与自己无关的专业、版本图纸，视觉干扰很强。</li>
                <li>面对大量图纸数据时，各角色像在数据海中捞针，找重点非常低效。</li>
                <li>页面以数据堆叠为主，没有针对角色和任务建立更主动的引导机制。</li>
              </ul>
            </TitleHeader>
